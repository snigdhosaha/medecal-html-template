    ...
    <body>
					...
					<div class="inner">
						<div class="row">
							<div class="col-lg-3 col-md-3 col-12">
								<!-- Start Logo -->
								<div class="logo">
									<a href="<?php echo get_template_directory_uri(). "/assets/index.html"?>"><img src="<?php echo get_template_directory_uri(). "/assets/img/logo.png"?>" alt="#"></a>
								</div>
								<!-- End Logo -->
								<!-- Mobile Nav -->
									...
									<nav class="navigation">
										<ul class="nav menu">
											<li class="active"><a href="#">Home <i class="icofont-rounded-down"></i></a>
												<ul class="dropdown">
													<li><a href="<?php echo get_template_directory_uri(). "/assets/index.php"?>">Home Page 1</a></li>
												</ul>
											</li>
		...
		<section class="slider">
			<div class="hero-slider">
				...
				<!-- End Single Slider -->
				<!-- Start Single Slider -->
				<div class="single-slider" style="background-image:url('<?php echo get_template_directory_uri(). "/assets/img/slider.jgp"?>')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
